...
walkRight = [
    pygame.image.load(imgPath + "\R1.png"),
    pygame.image.load(imgPath + "\R2.png"),
    pygame.image.load(imgPath + "\R3.png"),
    pygame.image.load(imgPath + "\R4.png"),
    pygame.image.load(imgPath + "\R5.png"),
    pygame.image.load(imgPath + "\R6.png"),
    pygame.image.load(imgPath + "\R7.png"),
    pygame.image.load(imgPath + "\R8.png"),
    pygame.image.load(imgPath + "\R9.png"),
]
walkLeft = [
    pygame.image.load(imgPath + "\L1.png"),
    pygame.image.load(imgPath + "\L2.png"),
    pygame.image.load(imgPath + "\L3.png"),
    pygame.image.load(imgPath + "\L4.png"),
    pygame.image.load(imgPath + "\L5.png"),
    pygame.image.load(imgPath + "\L6.png"),
    pygame.image.load(imgPath + "\L7.png"),
    pygame.image.load(imgPath + "\L8.png"),
